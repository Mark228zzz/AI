...
plt.show()
plt.savefig(f'{os.path.dirname(os.path.abspath(__file__))}/modules/five_generator/5.png')

name_of_modules = ('_35000ep_64x64', '_35000ep_64x64')

torch.save(netG, f'{os.path.dirname(os.path.abspath(__file__))}/modules/five_generator/NetG{name_of_modules[0]}.pth')
torch.save(netD, f'{os.path.dirname(os.path.abspath(__file__))}/modules/five_generator/NetD{name_of_modules[1]}.pth')
